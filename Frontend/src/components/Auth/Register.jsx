        ...
        <div className="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8 shadow">
          <div className="absolute inset-0">
            <img
              ...
              src="https://cdn.rareblocks.xyz/collection/celebration/images/signup/4/girl-registering.jpg"
              alt=""
            />
          </div>
        ...
        <div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
          <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
            ...
            <form action="#" method="POST" className="mt-8">
              ...
              <button
                type="submit"
                className="inline-flex justify-center w-full py-4 mt-6 font-medium text-white transition-all duration-200 bg-orange-500 border border-transparent rounded-md shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
              >
                Create Account
              </button>
            </form>
